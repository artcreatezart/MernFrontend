...
return (
  <div className='home'>
    <div className='workouts'>
      <button onClick={handleMyWorkouts} className='filterButton'><Filter/>My Workouts</button>
      <button onClick={handleAllWorkouts} className='filterButton'><Filter/>All Workouts</button>
